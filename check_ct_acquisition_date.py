...
patient_files_path = '/mnt/iDriveShare/hossein/1_RAWDATA/2016_2020_TSPINE_M2N/'

patient_folders = [os.path.join(patient_files_path, f) for f in os.listdir(patient_files_path)]
...
ct_times = 'ct_times_205.csv'
with open(ct_times, 'wb') as csvfile:
