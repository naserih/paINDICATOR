...
'''
This routine is to map note-service-date to the ct-accusition-date.
CT accusition dates are obtained using the get_ct_accusition_date.py and stored as CT_ACC_DATE.csv file
'''
